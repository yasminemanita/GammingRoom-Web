...
var gameEngine = { 
  ...
  deadlyTap: function() { // tapping a red circle
    ...
    $.get("/api/score/update/"+$("#gameId").val()+"/"+$("#idUser").val()+"/"+gameEngine.score, function(data, status){
      getScores();
      send=false;
    });
...
var audioPool = {
  ...
  createAudioPlayer: function(element) {
    ...
    mp3Link = "http://localhost:8000/sounds/mp3/" + element.sound + ".mp3";
    oggLink = "http://localhost:8000/sounds/ogg/" + element.sound + ".ogg";
